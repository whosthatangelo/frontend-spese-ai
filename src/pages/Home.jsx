          ...
          <div className="col-lg-10">
            ...
            <div className="row g-4">
              <div className="col-md-4">
                <div className="card border-0 bg-light rounded-4 text-center p-4 h-100">
        ...
        <div className="row justify-content-center">
          <div className="col-lg-10">
            ...
            <div className="card border-0 shadow-lg rounded-4 mb-5 overflow-hidden">
              <div className="card-header bg-gradient text-white border-0 py-4" style={{ background: 'linear-gradient(135deg, #667eea, #764ba2)' }}>
                <div className="row align-items-center">
                  <div className="col">
                    <h3 className="mb-1">🎙️ Centro di Registrazione</h3>
              ...
              <div className="card-body p-4">
                ...
                <div className="row g-3 mt-3">
                  <div className="col-md-4">
                    <div className="card bg-light border-0 rounded-3 p-3 text-center">
            ...
            <div className="row g-4 mb-5">
              <div className="col-md-4">
                <Link to="/spese" className="card border-0 shadow-sm rounded-4 text-decoration-none h-100 hover-card">
              ...
              <div className="col-md-4">
                <Link to="/incassi" className="card border-0 shadow-sm rounded-4 text-decoration-none h-100 hover-card">
                  <div className="card-body text-center p-4">
                    <div className="display-6 mb-3">💰</div>
              ...
              <div className="col-md-4">
                <Link to="/dashboard" className="card border-0 shadow-sm rounded-4 text-decoration-none h-100 hover-card">
                  <div className="card-body text-center p-4">
                    <div className="display-6 mb-3">📊</div>
